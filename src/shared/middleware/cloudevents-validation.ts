 ...
 */
 ...
 if (this.stats.errorRate > 0.1) {
   recommendations.push('High error rate > 10%; review producers and consider strictMode');
 }
 ...
 if (mostCommonError) {
   recommendations.push(`Most common error: ${mostCommonError[0]} (${mostCommonError[1]})`);
 }
 }
